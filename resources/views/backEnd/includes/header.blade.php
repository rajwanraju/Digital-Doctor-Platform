...
@if(Auth::user()->user_Type != 'admin')
                    <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">  <i class="font-24 mdi mdi-comment-processing"></i>
                    </a>
                     <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{url('compose/message')}}">Compose</a>
                        <a class="dropdown-item" href="{{url('message/list')}}">Inbox</a>
                    </div>
                </li>
